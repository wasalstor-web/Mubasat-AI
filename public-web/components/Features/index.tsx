    ...
    return (
        <section className="py-20 md:py-24">
            <div className="container">
                <h2 className="text-5xl md:text-6xl font-medium text-center tracking-tighter">ارفع مستوى جهودك في SEO.</h2>
                <p className="text-white/70 text-lg md:text-xl max-w-2xl mx-auto tracking-tight text-center mt-5">
                    من الشركات الناشئة الصغيرة إلى المؤسسات الكبيرة، أحدثت أداتنا المدعومة بالذكاء الاصطناعي ثورة في طريقة تعامل الشركات مع SEO.
                </p>
