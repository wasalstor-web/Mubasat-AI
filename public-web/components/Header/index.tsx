                ...
                <div className="relative flex items-center justify-between md:border border-white/15 md:p-2.5 rounded-xl max-w-2xl mx-auto">
                    ...
                    <div className="hidden md:block">
                        <nav className="flex gap-8 text-sm">
                            <Link href={`#`} className="text-white/70 hover:text-white transition">المميزات</Link>
                            <Link href={`#`} className="text-white/70 hover:text-white transition">المطورين</Link>
                            <Link href={`#`} className="text-white/70 hover:text-white transition">الأسعار</Link>
                            <Link href={`#`} className="text-white/70 hover:text-white transition">سجل التغييرات</Link>
                        </nav>
                    </div>
                    <div className="flex gap-4 items-center">
                        <Button>انضم لقائمة الانتظار</Button>
